...
public static class MensajesError
{
    ...
    public const string UsuarioNoAdminSistema = "El solicitante no es administrador de sistema.";
    ...
    public const string ContrasenaSinCaracterEspecial = "La contraseña debe incluir al menos un carácter especial (como @, #, $, etc.).";
