...
public class Tarea
{
    ...
    public Tarea(string unTitulo, string unDescripcion, int unaDuracionEnDias,
        DateTime? unaFechaInicioMasTemprana = null)
    {
    ...
    public Tarea(int unId, string unTitulo, string unaDescripcion, int unaDuracionEnDias,
        DateTime? unaFechaInicioMasTemprana = null)
