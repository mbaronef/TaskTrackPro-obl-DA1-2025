...
public class GestorProyectosTests
{
    ...
    public void ModificarDescripcionDelProyecto_NotificaALosMiembrosDelProyecto()
    {
        ...
        string mensajeEsperado =
            $"Se cambió la descripción del proyecto '{proyecto.Nombre}' a '{nuevaDescripcion}'.";
    ...
    public void CambiarAdministradorDeProyecto_NotificaALosMiembros()
    {
        ...
        string msg =
            $"Se cambió el administrador del proyecto '{proyecto.Nombre}'. El nuevo administrador es '{nuevoAdmin}'.";
    ...
    public void AgregarMiembro_NotificaALosMiembros()
    {
        ...
        string esperado =
            $"Se agregó a un nuevo miembro (id {_usuarioNoAdmin.Id}) al proyecto '{proyecto.Nombre}'.";
